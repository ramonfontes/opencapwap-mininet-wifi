...
#ifdef CONFIG_DRIVER_CAPWAP_WTP
extern const struct wpa_driver_ops wpa_driver_capwap_wtp_ops; /* driver_capwap_wtp.c */
#endif /* CONFIG_DRIVER_CAPWAP_WTP */
#ifdef CONFIG_DRIVER_CAPWAP
extern const struct wpa_driver_ops wpa_driver_capwap_ops; /* driver_capwap.c */
